        ...
        child: RefreshIndicator(
          ...
          child: FutureBuilder<List>(
              ...
              builder: (context, snapshot) {
                ...
                final categories = snapshot.data![0] as List<CategoryRecord?>;

                final subCategories =
                    snapshot.data![1]! as List<SubCategoryRecord?>;
                return Container(
    ...
    return Padding(
      ...
      child: TextButton(
        style: TextButton.styleFrom(
          primary: MyTheme.of(context).primaryText,
